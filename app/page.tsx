...
import { ResumeData, WorkExperienceDate } from '@/app/types/types'
  ...
  return (
    <main className="container relative mx-auto scroll-my-12 overflow-auto p-4 print:p-12 md:p-16">
      <section className="mx-auto w-full max-w-2xl space-y-8 bg-white print:space-y-4">
        <div className="flex items-center justify-between">
          ...
          <Avatar className="size-28 rounded-xl">
            <AvatarImage alt={RESUME_DATA.name[language]} src="/photo.jpg" />
      ...
      <Button
        ...
        className="fixed bottom-20 right-4 w-13 h-13 rounded-full shadow-lg z-50 flex items-center justify-center print:hidden cursor-pointer"
        variant="outline"
        title={UIText['print'][language]}
      >
        <Icon icon="lineicons:printer" className="w-8 h-8" />
      </Button>
